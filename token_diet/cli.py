...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="token-diet", description="Token Diet - The lightweight context-compression layer for LLM agents"
    )
    ...
    proxy_parser.add_argument(
        "--port", type=int, default=8787, help="Port to listen for incoming requests (default: 8787)"
    )
    proxy_parser.add_argument(
        "--threshold", type=int, default=1000, help="Compression threshold in characters (default: 1000)"
    )
