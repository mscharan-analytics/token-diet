...
class SQLiteCache:
    ...
    def __init__(self, db_path: Optional[str] = None):
        ...
        if db_path is None:
            ...
            try:
                ...
                warnings.warn(f"Failed to access home config folder, trying local DB: {e}", RuntimeWarning)
        ...
        try:
            ...
            warnings.warn(
                f"Failed to initialize SQLite database cache: {e}. "
                "Token Diet is falling back to an in-memory cache.",
                RuntimeWarning
            )
    ...
    def put(self, cache_id: str, original_text: str) -> None:
        ...
        try:
            ...
            warnings.warn(f"Failed to write to SQLite cache: {e}. Storing in memory.", RuntimeWarning)
    ...
    def get(self, cache_id: str) -> Optional[str]:
        ...
        try:
            ...
            warnings.warn(f"Failed to read from SQLite cache: {e}.", RuntimeWarning)
            return None
    ...
    def clear(self) -> None:
        ...
        try:
            ...
            warnings.warn(f"Failed to clear SQLite cache: {e}.", RuntimeWarning)
